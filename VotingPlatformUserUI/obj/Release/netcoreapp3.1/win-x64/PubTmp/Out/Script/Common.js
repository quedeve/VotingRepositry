...
function LoginMenu(fullName) {
    var menu = "";
    
    menu+='<div class="dropdown">';
    menu+='<button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">';
    menu+='Welcome, ' + fullName;
    menu+='</button>';
    menu+='<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">';
    menu+='<a class="dropdown-item" href="#" data-toggle="modal" data-target="#logoutModal">Logout</a>';
    menu+=' </div></div>';
    return menu;
}
